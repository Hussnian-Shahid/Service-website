...
const Paid = () => {
  ...
  return (
    <div className=" animate__animated animate__fadeInUp animate__delay-1s md:px-[100px] mx-auto md:py-[100px] px-7.5 pb-20">
      ...
      <div className="md:flex justify-between items-end">
        <div className="flex flex-col text-4xl pt-5 md:text-6xl font-bold">
          <div>
            <span className="text-orange-400">S</span>tay chill and
          </div>
      ...
      {/* ✅ Fixed Grid Layout */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:py-[50px]">
        {price.map((pr, index) => (
          <div
            key={index}
