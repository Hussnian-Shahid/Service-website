...
const Aboutmenu = () => {
  return (
    <div>
      <Navbar />
      <div className="md:py-[100px] bg-[#FFE9D9]  py-[50px]  md:w-full mx-auto md:flex md:flex-row  md:justify-center md:items-center md:gap-30   ">
        <div className="md:w-[600px] w-fit pb-20  md:p-20:">
          <img src="./about2.png" className="" alt="picture" />
        </div>
        <div className="flex flex-col  px-10 md:w-[600px]">
          ...
          <div className="text-[#6B6B6B] text-[20px] ">
            ...
            technologies, building responsive web applications, RESTful APIs,
            and databases. Passionate about clean code, problem-solving, and
