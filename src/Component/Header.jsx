...
const Header = () => {
  return (
    <div className="bg-[#FFE9D9]  font-Syne relative md:w-full  md:bg-[url('/hero.png')] md:bg-no-repeat md:bg-right-bottom md:bg-contain">
      <Navbar />
      <section className="md:pt-[100px] md:pl-[100px]  py-[50px] font-Syne md:max-w-full ">
        <div className="font-Syne ">
          <div className="md:text-5xl text-2xl font-bold text-center md:text-start ">
            Assalam-o-Alikum, I'm
          </div>
          <div class=" md:text-start text-center md:text-9xl text-4xl font-bold">
            <span className="text-orange-400">H</span>ussnain
          </div>
          <div class=" text-center md:text-9xl text-4xl font-bold md:text-start ">
            Shahid
          </div>
          <div className="font-bold text-[18px] py-5  md:text-2xl md:mb-8 pl-7.5 ">
            Product Designer | Based in Pakistan
          </div>
          <div className="flex md:justify-start justify-center items-center gap-3 transition-all  font-bold  md:text-[20px] text-center">
          ...
          <div className="flex md:justify-start md:flex-row flex-col items-center  pt-18 pl-7.5  ">
