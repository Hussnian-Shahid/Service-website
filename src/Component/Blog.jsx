...
const Blog = () => {
  ...
  return (
    <div className=" animate__animated animate__fadeInUp animate__delay-1s md:px-[100px] mx-auto pt-7.5 px-7.5 ">
      ...
      <div className="font-bold text-3xl md:text-6xl text-center">
        <span className="text-orange-400">M</span>y blog post
      </div>
      <Link to="/blogdetail">
        <div className="pt-15 grid grid-cols-1  md:grid-cols-4  md:space-x-10">
          {blog &&
            blog.map((blo, index) => (
