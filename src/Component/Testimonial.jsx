            ...
            <Slider {...settings}>
              <div className="">
                ...
                <div className="font-bold">
                  ...
                  businesses succeed. Building with empathy and strategy ensures
                  growth. Every decision counts and each effort leads to
                  transformation. Staying motivated and focused drives long-term
                  success across all industries and cultures."
                </div>
              ...
              <div>
                ...
                <div className="font-bold">
                  ...
                  turns imagination into reality. Real success lies not just in
                  profits, but in positive change. Teams thrive when values
                  align. Creating user-centered solutions brings lasting value.
                  With the right mindset, even the impossible becomes achievable
              ...
              <div>
                ...
                <div className="font-bold">
                  ...
                  innovation simplifies life, not complicates it. Empathy is the
                  key to connection, especially in technology. Clear goals
              ...
              <div>
                <div className="text-8xl font-bold">,,</div>
                <div className="font-bold">
                  "Customer satisfaction begins with listening. Honest feedback
                  helps refine products. Authenticity builds loyalty. Delivering
                  consistent value creates a strong reputation. Sustainable
                  growth happens when business meets purpose. Each success story
                  is built one step at a time. Patience and effort, together,
                  can accomplish more than raw talent ever will."
                </div>
                <div className="text-center font-bold text-2xl">
                  -Ava Thompson-
                </div>
