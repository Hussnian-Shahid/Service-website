  ...
  return (
    <div className="w-full  bg-black">
      <div className="md:w-[1200px] text-white py-[100px] bg-black mx-auto ">
        <div className="grid grid-cols-1 space-y-5  md:grid-cols-3 space-x-5 rounded-2xl ">
          <div>
            <div className="font-bold text-6xl pt-[30px]  pb-[25px]">
              Let's work together
            </div>
        ...
        <div className="font-bold text-5xl px-5 md:text-center md:text-[126px] py-5 text-[#e8d9d9] border-b-[1px] border-white ">
          Hussnain Shahid
        </div>
        <div className=" text-white flex justify-between items-center py-5 ">
          ...
          <div className=" hover:text-orange-400 cursor-pointer  space-x-4 transition-all  ">
            <div className="md:flex gap-5 border-l-[1px] border-white border-t-[1px]  md:justify-center items-center ">
              <div className='p-4' >Back to top </div>
              <div>
                <svg
                  className="-rotate-45 text-[15px] font-bold text-white"
                  width="18px"
                  height="18px"
                  viewBox="0 0 1024 1024"
                  xmlns="http://www.w3.org/2000/svg"
