            ...
            {tabs.map((tab, index) => (
              ...
              >
                <button
                  ...
                  className={` group font-bold flex justify-between items-center  w-[310px] rounded-[5px] p-3.5 hover:bg-black hover:text-white ${
    ...
    return (
      ...
      <div className="flex flex-col gap-y-5">
        <div className="bg-[#FFFFFF] rounded flex gap-5 p-5 items-center ">
          ...
          <div>
            <div className="text-2xl">Axtra</div>
            <div className="text-3xl font-bold">BA Business Management</div>
          </div>
        </div>
        <div className="bg-[#FFFFFF] rounded flex gap-5 p-5 items-center ">
          <div className="text-gray-400">003/2008-07/2011</div>
          ...
          {language.map((languag, index) => (
            ...
            >
              ...
              <div className="flex justify-center flex-col items-center">
                ...
                <div className="text-3xl font-bold"> {languag.done} </div>
              </div>
            </div>
          ))}
        </div>
